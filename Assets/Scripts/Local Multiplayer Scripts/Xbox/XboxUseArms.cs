...
public class XboxUseArms : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerInput.XboxInput.UseLeftArm.performed += context => startLeftBumperPressedTimer = true;
        playerInput.XboxInput.UseLeftArm.canceled += context => startLeftBumperPressedTimer = false;


        // Looks if thew input action is being preformed or has been canceled canceled and sets a bool to true or fasle.
        playerInput.XboxInput.UseRightArm.performed += context => startRightBumperPressedTimer = true;
        playerInput.XboxInput.UseRightArm.canceled += context => startRightBumperPressedTimer = false;
    }
