...
public class WalkingAnimation : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerInput.PlaystationInput.ContollerMovement.performed += context => iswalking = true;
        playerInput.PlaystationInput.ContollerMovement.canceled += context => iswalking = false;
    }


    private void OnEnable()
    {
        playerInput.PlaystationInput.ContollerMovement.Enable();
    }
    ...
    {
        playerInput.PlaystationInput.ContollerMovement.Disable();
    }
